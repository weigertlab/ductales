...
public class DuctalesConstants {
	...
	public static double DEFAULT_FIND_DUCT_DOWNSAMPLE = 4;
	...
	public static double DEFAULT_DUCT_STRUCTURE_MAX_DISTANCE = 30;
	public static int DEFAULT_DUCT_STRUCTURE_MIN_CELL_SIZE = 10;
	public static boolean DEFAULT_DUCT_MEASURE = true;
	public static double[] DEFAULT_DUCT_HOLES_MIN_DISTANCES = {20., 30.};
